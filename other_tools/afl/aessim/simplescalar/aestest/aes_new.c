...
//void aes_encrypt(uchar in[], uchar out[], uchar key[], int keysize)
{
   ...
   SubBytes(state); ShiftRows(state); AddRoundKey(state,&key[36]);
#endif
	 if (keysize != 128) {
...
int main() 
{
	...
	uchar in[16] = {0x10, 0x11, 0x02, 0x03, 0x04, 0x55, 0x76, 0x07, 0x88, 0x91, 0x0A, 0xB1, 0xCF, 0xDD, 0xEE, 0xF0};
	uchar out[16];


	 uchar key[16] = { 18,0,38,123,239,43,195,13,17,150,200,35,102,48,212,226};	
