#include "klee.h"
/* __MC__ */ int C__7=0;
/* __MC__ */ char flag__0x4004e0=0;
/* __MC__ */ char flag__0x4008e0=0;
/* __MC__ */ char flag__0x400ce0=0;
...
#define PBITS	16
#define BITS 16
#define HSIZE	256		/* 95% occupancy was 69001 */
...
/* __MC__ */__COUNT_MACRO(flag__0x4004e0,C__7);
   hsize_reg = hsize;
...
void cl_block (void)		/* table clear for block compress */
{
   ...
   if ( rat > ratio ) {
      ...
      ratio = 0;
/* __MC__ */__COUNT_MACRO(flag__0x4008e0,C__7);
   ...
   */
   ...
   if ( code >= 0 ) {
      ...
      *bp = (*bp & rmask[r_off]) | (code << r_off) & lmask[r_off];  /* apsim_unknown buf */
      ...
      offset += n_bits;
      if ( offset == (n_bits << 3) ) {
/* __MC__ */__COUNT_MACRO(flag__0x400ce0,C__7);
         bp = buf;
         bits = n_bits;
         bytes_out += bits;
         do {
