...
@inp = global [35 x %struct.input_data] [%struct.input_data { double 0.000000e+00, double 0.000000e+00, double 9.000000e+01, double 5.000000e-02 }, %struct.input_data { double 1.000000e+02, double 0.000000e+00, double 9.000000e+01, double 5.000000e-02 },
@u0d = internal global double 0.000000e+00, align 8 ; <double*> [#uses=4]
...
entry:
  ...
  %tmp4 = getelementptr [4 x i8]* @.str, i32 0, i32 0 ; <i8*> [#uses=1]
  %tmp5 = call i32 (...)* @klee_make_symbolic(double* @u0d, i32 8, i8* %tmp4) nounwind ; <i32> [#uses=0]
...
bb6:                                              ; preds = %bb22
  ...
  %tmp9 = fadd double %tmp78, 5.000000e-01        ; <double> [#uses=1]
  %tmp10 = load double* %step, align 8            ; <double> [#uses=1]
  %tmp11 = fmul double %tmp9, %tmp10              ; <double> [#uses=1]
  store double %tmp11, double* %x, align 8
  %tmp13 = load double* %x, align 8               ; <double> [#uses=1]
  %tmp14 = load double* %x, align 8               ; <double> [#uses=1]
  %tmp15 = fmul double %tmp13, %tmp14             ; <double> [#uses=1]
  %tmp16 = fadd double %tmp15, 1.000000e+00       ; <double> [#uses=1]
  %tmp17 = fdiv double 4.000000e+00, %tmp16       ; <double> [#uses=1]
  %tmp18 = load double* %sum, align 8             ; <double> [#uses=1]
  %tmp19 = fadd double %tmp17, %tmp18             ; <double> [#uses=1]
  store double %tmp19, double* %sum, align 8
  %tmp20 = load i32* %i, align 4                  ; <i32> [#uses=1]
  %tmp21 = add i32 %tmp20, 1                      ; <i32> [#uses=1]
  store i32 %tmp21, i32* %i, align 4
  br label %bb22

bb22:                                             ; preds = %bb6, %bb
  %tmp23 = load i32* @num_steps, align 4          ; <i32> [#uses=1]
  %tmp24 = load i32* %i, align 4                  ; <i32> [#uses=1]
  %tmp25 = icmp slt i32 %tmp24, %tmp23            ; <i1> [#uses=1]
  %tmp2526 = zext i1 %tmp25 to i8                 ; <i8> [#uses=1]
  %toBool = icmp ne i8 %tmp2526, 0                ; <i1> [#uses=1]
  br i1 %toBool, label %bb6, label %bb27

bb27:                                             ; preds = %bb22
  %tmp28 = load double* %sum, align 8             ; <double> [#uses=1]
  %tmp29 = load double* %step, align 8            ; <double> [#uses=1]
  %tmp30 = fmul double %tmp28, %tmp29             ; <double> [#uses=1]
  store double %tmp30, double* %pi, align 8
  store i32 0, i32* %tid2, align 4
  %tmp31 = load double* %a, align 8               ; <double> [#uses=1]
  %tmp32 = fcmp olt double %tmp31, 0.000000e+00   ; <i1> [#uses=1]
  %tmp3233 = zext i1 %tmp32 to i8                 ; <i8> [#uses=1]
  %toBool34 = icmp ne i8 %tmp3233, 0              ; <i1> [#uses=1]
  br i1 %toBool34, label %bb40, label %bb35

bb35:                                             ; preds = %bb27
  %tmp36 = load double* %a, align 8               ; <double> [#uses=1]
  %tmp37 = fcmp ogt double %tmp36, 1.500000e+03   ; <i1> [#uses=1]
  %tmp3738 = zext i1 %tmp37 to i8                 ; <i8> [#uses=1]
  %toBool39 = icmp ne i8 %tmp3738, 0              ; <i1> [#uses=1]
  br i1 %toBool39, label %bb40, label %bb41

bb40:                                             ; preds = %bb35, %bb27
  store double 0.000000e+00, double* @u0d, align 8
  br label %bb46

bb41:                                             ; preds = %bb35
  %tmp42 = load i32* %lid, align 4                ; <i32> [#uses=1]
  %tmp43 = getelementptr [35 x %struct.input_data]* @inp, i32 0, i32 %tmp42 ; <%struct.input_data*> [#uses=1]
  %tmp44 = getelementptr %struct.input_data* %tmp43, i32 0, i32 0 ; <double*> [#uses=1]
  %tmp45 = load double* %tmp44, align 4           ; <double> [#uses=1]
  store double %tmp45, double* @u0d, align 8
  br label %bb46

bb46:                                             ; preds = %bb41, %bb40
  %tmp47 = load double* %b, align 8               ; <double> [#uses=1]
  %tmp48 = fcmp olt double %tmp47, 0.000000e+00   ; <i1> [#uses=1]
  %tmp4849 = zext i1 %tmp48 to i8                 ; <i8> [#uses=1]
  %toBool50 = icmp ne i8 %tmp4849, 0              ; <i1> [#uses=1]
  br i1 %toBool50, label %bb56, label %bb51

bb51:                                             ; preds = %bb46
  %tmp52 = load double* %b, align 8               ; <double> [#uses=1]
  %tmp53 = fcmp ogt double %tmp52, 5.000000e+04   ; <i1> [#uses=1]
  %tmp5354 = zext i1 %tmp53 to i8                 ; <i8> [#uses=1]
  %toBool55 = icmp ne i8 %tmp5354, 0              ; <i1> [#uses=1]
  br i1 %toBool55, label %bb56, label %bb57

bb56:                                             ; preds = %bb51, %bb46
  store double 0.000000e+00, double* @altd, align 8
  br label %bb62

bb57:                                             ; preds = %bb51
  %tmp58 = load i32* %lid, align 4                ; <i32> [#uses=1]
  %tmp59 = getelementptr [35 x %struct.input_data]* @inp, i32 0, i32 %tmp58 ; <%struct.input_data*> [#uses=1]
  %tmp60 = getelementptr %struct.input_data* %tmp59, i32 0, i32 1 ; <double*> [#uses=1]
  %tmp61 = load double* %tmp60, align 4           ; <double> [#uses=1]
  store double %tmp61, double* @altd, align 8
  br label %bb62

bb62:                                             ; preds = %bb57, %bb56
  %tmp63 = load double* %c, align 8               ; <double> [#uses=1]
  %tmp64 = fcmp olt double %tmp63, 4.500000e+01   ; <i1> [#uses=1]
  %tmp6465 = zext i1 %tmp64 to i8                 ; <i8> [#uses=1]
  %toBool66 = icmp ne i8 %tmp6465, 0              ; <i1> [#uses=1]
  br i1 %toBool66, label %bb72, label %bb67

bb67:                                             ; preds = %bb62
  %tmp68 = load double* %c, align 8               ; <double> [#uses=1]
  %tmp69 = fcmp ogt double %tmp68, 9.000000e+01   ; <i1> [#uses=1]
  %tmp6970 = zext i1 %tmp69 to i8                 ; <i8> [#uses=1]
  %toBool71 = icmp ne i8 %tmp6970, 0              ; <i1> [#uses=1]
  br i1 %toBool71, label %bb72, label %bb73

bb72:                                             ; preds = %bb67, %bb62
  store double 1.000000e+02, double* @throtl, align 8
  br label %bb85

bb73:                                             ; preds = %bb67
  %tmp74 = load i32* %lid, align 4                ; <i32> [#uses=1]
  %tmp75 = getelementptr [35 x %struct.input_data]* @inp, i32 0, i32 %tmp74 ; <%struct.input_data*> [#uses=1]
  %tmp76 = getelementptr %struct.input_data* %tmp75, i32 0, i32 2 ; <double*> [#uses=1]
  %tmp77 = load double* %tmp76, align 4           ; <double> [#uses=1]
  %tmp79 = load double* %pi, align 8              ; <double> [#uses=1]
  %tmp80 = call double @deg2rad(double %tmp77, double %tmp79) nounwind ; <double> [#uses=1]
  %tmp81 = fmul double %tmp80, 1.000000e+02       ; <double> [#uses=1]
  %tmp82 = fmul double %tmp81, 2.000000e+00       ; <double> [#uses=1]
  %tmp83 = load double* %pi, align 8              ; <double> [#uses=1]
  %tmp84 = fdiv double %tmp82, %tmp83             ; <double> [#uses=1]
  store double %tmp84, double* @throtl, align 8
  br label %bb85

bb85:                                             ; preds = %bb73, %bb72
  %tmp86 = load double* %d, align 8               ; <double> [#uses=1]
  %tmp87 = fcmp olt double %tmp86, 0.000000e+00   ; <i1> [#uses=1]
  %tmp8788 = zext i1 %tmp87 to i8                 ; <i8> [#uses=1]
  %toBool89 = icmp ne i8 %tmp8788, 0              ; <i1> [#uses=1]
  br i1 %toBool89, label %bb90, label %bb91
...
bb91:                                             ; preds = %bb85
  %tmp92 = load i32* %lid, align 4                ; <i32> [#uses=1]
  %tmp93 = getelementptr [35 x %struct.input_data]* @inp, i32 0, i32 %tmp92 ; <%struct.input_data*> [#uses=1]
  %tmp94 = getelementptr %struct.input_data* %tmp93, i32 0, i32 3 ; <double*> [#uses=1]
  %tmp95 = load double* %tmp94, align 4           ; <double> [#uses=1]
  store double %tmp95, double* %TimePoint, align 8
  br label %bb96

bb96:                                             ; preds = %bb91, %bb90
  %tmp97 = load double* %TotalTimePoint, align 8  ; <double> [#uses=1]
  %tmp98 = load double* %TimePoint, align 8       ; <double> [#uses=1]
  %tmp99 = fadd double %tmp97, %tmp98             ; <double> [#uses=1]
  store double %tmp99, double* %TotalTimePoint, align 8
  ...
  %tmp100 = load double* %TotalUsed, align 8      ; <double> [#uses=1]
  %tmp101 = load double* %used, align 8           ; <double> [#uses=1]
  %tmp102 = fadd double %tmp100, %tmp101          ; <double> [#uses=1]
  store double %tmp102, double* %TotalUsed, align 8
  %tmp103 = load i32* %NumPoints, align 4         ; <i32> [#uses=1]
  %tmp104 = add i32 %tmp103, 1                    ; <i32> [#uses=1]
  store i32 %tmp104, i32* %NumPoints, align 4
  %tmp105 = load double* %used, align 8           ; <double> [#uses=1]
  %tmp106 = fcmp ogt double %tmp105, 1.000000e+00 ; <i1> [#uses=1]
  %tmp106107 = zext i1 %tmp106 to i8              ; <i8> [#uses=1]
  %toBool108 = icmp ne i8 %tmp106107, 0           ; <i1> [#uses=1]
  br i1 %toBool108, label %bb109, label %bb115

bb109:                                            ; preds = %bb96
  %tmp110 = load i32* %NumMissed, align 4         ; <i32> [#uses=1]
  %tmp111 = add i32 %tmp110, 1                    ; <i32> [#uses=1]
  store i32 %tmp111, i32* %NumMissed, align 4
  %tmp112 = load double* %TotalTimePoint, align 8 ; <double> [#uses=1]
  %tmp113 = load double* %usedTime, align 8       ; <double> [#uses=1]
  %tmp114 = fadd double %tmp112, %tmp113          ; <double> [#uses=1]
  store double %tmp114, double* %TotalTimePoint, align 8
  br label %bb115

bb115:                                            ; preds = %bb109, %bb96
  %tmp116 = load i32* %lid, align 4               ; <i32> [#uses=1]
  %tmp117 = add i32 %tmp116, 1                    ; <i32> [#uses=1]
  store i32 %tmp117, i32* %lid, align 4
  br label %bb118

bb118:                                            ; preds = %bb115, %entry
  %tmp119 = load i32* %lid, align 4               ; <i32> [#uses=1]
  %tmp120 = icmp sle i32 %tmp119, 34              ; <i1> [#uses=1]
  %tmp120121 = zext i1 %tmp120 to i8              ; <i8> [#uses=1]
  %toBool122 = icmp ne i8 %tmp120121, 0           ; <i1> [#uses=1]
  br i1 %toBool122, label %bb, label %bb123

bb123:                                            ; preds = %bb118
  store i32 0, i32* %tmp, align 4
  %tmp124 = load i32* %tmp, align 4               ; <i32> [#uses=1]
  store i32 %tmp124, i32* %retval, align 4
  %retval125 = load i32* %retval                  ; <i32> [#uses=1]
  ret i32 %retval125
}
...
bb358:                                            ; preds = %bb334, %bb329
  ...
  br i1 %toBool362, label %bb363, label %return
...
bb125:                                            ; preds = %bb122, %bb112
  ...
  br i1 %toBool135, label %bb136, label %return
...
entry:
  ...
  %tmp23 = zext i1 %tmp2 to i8                    ; <i8> [#uses=1]
  %toBool = icmp ne i8 %tmp23, 0                  ; <i1> [#uses=1]
  %tmp4 = load double* %x_addr, align 8           ; <double> [#uses=2]
...
bb10:                                             ; preds = %bb4
  ...
  %tmp1213 = zext i1 %tmp12 to i8                 ; <i8> [#uses=1]
  %toBool14 = icmp ne i8 %tmp1213, 0              ; <i1> [#uses=1]
  br i1 %toBool14, label %bb15, label %bb35
...
entry:
  ...
  %tmp23 = zext i1 %tmp2 to i8                    ; <i8> [#uses=1]
  %toBool = icmp ne i8 %tmp23, 0                  ; <i1> [#uses=1]
  br i1 %toBool, label %bb, label %bb18
...
entry:
  %x_addr = alloca double                         ; <double*> [#uses=5]
  %y_addr = alloca double                         ; <double*> [#uses=4]
  %retval = alloca double, align 8                ; <double*> [#uses=2]
  %partieEntiere = alloca i32                     ; <i32*> [#uses=4]
...
bb13:                                             ; preds = %bb, %entry
  ...
  %tmp21 = call double @power(double %tmp19, i32 %tmp20) nounwind ; <double> [#uses=2]
...
bb22:                                             ; preds = %bb13
  ...
  %tmp34 = fmul double %tmp21, %tmp33             ; <double> [#uses=1]
...
entry:
  ...
  %retval = alloca double, align 8                ; <double*> [#uses=2]
  %i = alloca i32                                 ; <i32*> [#uses=4]
  %number = alloca double, align 8                ; <double*> [#uses=3]
  %tmp = alloca double, align 8                   ; <double*> [#uses=3]
  %"alloca point" = bitcast i32 0 to i32          ; <i32> [#uses=0]
  store double %x, double* %x_addr
...
bb16:                                             ; preds = %bb10, %bb9
  ...
  %tmp1920 = zext i1 %tmp19 to i8                 ; <i8> [#uses=1]
  %toBool21 = icmp ne i8 %tmp1920, 0              ; <i1> [#uses=1]
  %tmp11 = load double* %number, align 8          ; <double> [#uses=2]
  br i1 %toBool21, label %bb10, label %bb22

bb22:                                             ; preds = %bb16
  store double %tmp11, double* %tmp, align 8
  br label %bb25
