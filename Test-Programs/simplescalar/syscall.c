	...
	if (/*timeval*/regs->regs_R[5] == 0)
	  {
	    ...
	    /*result*/regs->regs_R[2] = utime(buf, NULL);
#elif defined(__svr4__) || defined(__USLC__) || defined(unix) || defined(_AIX) || defined(__alpha) || defined(__MACH__)
...
#elif defined(__USLC__) || defined(unix) || defined(_AIX) || defined(__alpha) || defined(__MACH__)
