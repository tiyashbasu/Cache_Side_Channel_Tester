...
;
;                PMC Test target_name for multiple threads
;                           NASM syntax
;
; This target_name is intended for testing the performance of a little piece of
...
; will be output for each repetition. This target_name measures how many clock
...
;   all other registers: available to user target_name
