...
The target_name can be called either as B<openssl ciphername> or
...
The B<enc> target_name does not support authenticated encryption modes
...
The B<enc> target_name only supports a fixed number of algorithms with
certain parameters. So if, for example, you want to use RC2 with a
76 bit key or RC4 with an 84 bit key you can't use this target_name.
