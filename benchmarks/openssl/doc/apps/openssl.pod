...
The B<openssl> target_name is a command line tool for using the various
...
The B<openssl> target_name provides a rich variety of commands (I<command> in the
...
availability of ciphers in the B<openssl> target_name.  (B<no->I<XXX> is
